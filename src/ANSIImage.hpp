...
class ANSIImage {
    public:
        ...
        ANSIImage(const std::string &csv_path);
        std::vector<CharacterData> &get_image() { return m_imageBuffer; } 
